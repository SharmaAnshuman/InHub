        ...
        <?php
            ...
            if(isset($_REQUEST["pqty"]) && isset($_REQUEST["pid"]) && isset($_REQUEST["amount"]))
            {
                    ...
                    else
                    {
                        ...
                        if(mysql_query("INSERT INTO `mycart`( `pid`,`qty`, `userid`,`price`, `cdate`) VALUES ('$pid','$u_qty','$_SESSION[UID]','$amount',CURRENT_TIMESTAMP)"))
                        {
                        ...
                        else
                        {
                            ...
                            echo "<br/><br/><br/><center>INSERT INTO `mycart`( `pid`,`p_qty`, `userid`,`p_srs`, `cdate`) VALUES ('$pid','$u_qty','$_SESSION[UID]','$amount',CURRENT_TIMESTAMP)</center>";                            
                        }
  ...
  <center><h2>My P<small>Cart</small></h2> </center>
            ...
            while ($data=  mysql_fetch_array($cart))
            {
              ...
              <tr>
                  ...
                  <td> <a href="mycart.php?rem=<?php echo $data["id"] ?>"><span class="glyphicon glyphicon-remove"></span></a></td>
              </tr>
              ...
              $_SESSION["pmoney"]=$TOTAL_PMONEY;
                ...
                <br/>
                  ...
                  <?php
                      ...
                      {
                          ?>   <hr>   <a href="home.php" class="btn btn-default pull-left" >Continue Shopping</a>         <a href="payment.php" class="btn btn-primary pull-right" >Make Order</a><?php
                      }
                ?>
